...
function CatalogIntraocularPage() {
	const { id } = useParams();
	console.log(id);
	...
	useEffect(() => {
		axios
			.get(`http://localhost:3000/catalogIntraocular/${id}`)
...
export default CatalogIntraocularPage;
		...
		<div>
			<div className="container mb-120">
				<div className="grid w-full grid-cols-1 md:grid-cols-5 detail-card-box">
					<img className="md:col-span-2 detail-card-img" src={CatalogImg} alt={data.name} />
